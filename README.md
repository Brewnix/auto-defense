...
**Status:** **slice 4** — zero-LLM loop + auditor drain + Hypermesh preempt client / H3. See [`docs/slice-4-preempt.md`](docs/slice-4-preempt.md).  
**License:** [MIT](LICENSE)  
...
`0 → 1 → 2 → 4 → 5` then package. **Slices 0–2 and 4 in this tree.**
...
4. Preempt client + H3 (`/site/jobs`, `/site/devices`, H4 offline, site_defense hook) — [`docs/slice-4-preempt.md`](docs/slice-4-preempt.md) — **this tree**  
5. AImmune UI v0  
