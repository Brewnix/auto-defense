...
**Status:** **Soft Soft testable cottage v0** — slices 0–9 + SIWE + synthetics + packaging + testing harden already on main; Product Soft Soft is [`docs/soft-soft-aimmune-testable-v0.md`](docs/soft-soft-aimmune-testable-v0.md).  
**License:** [MIT](LICENSE)  
