...
**Status:** **slice 2** — zero-LLM loop + `notify.operator` → fyber.auditor drain / poll / apply / ack. See [`docs/slice-2-auditor.md`](docs/slice-2-auditor.md).  
**License:** [MIT](LICENSE)  
...
`0 → 1 → 2 → 4 → 5` then package. **Slices 0–2 in this tree.**
...
2. `notify.operator` auditor client — [`docs/slice-2-auditor.md`](docs/slice-2-auditor.md) — **this tree**  
